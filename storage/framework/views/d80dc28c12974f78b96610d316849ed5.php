...
<?php $__env->startSection('meta_description', 'Website resmi B University — informasi profil, dosen, fasilitas, pengumuman, dan berita kampus.'); ?>
    ...
    <div class="relative mx-auto grid max-w-7xl items-center gap-10 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:px-8 lg:py-28">
        <div>
            ...
            <p class="mt-6 max-w-2xl text-lg leading-8 text-blue-100">
                <?php echo e(\Illuminate\Support\Str::limit(strip_tags($aboutme->content ?? 'B University adalah institusi pendidikan tinggi yang berkomitmen menghasilkan lulusan unggul, adaptif, dan siap menghadapi perkembangan teknologi.'), 190)); ?>
            ...
            <div class="mt-8 flex flex-col gap-3 sm:flex-row">
                ...
                <a href="<?php echo e(route('lectures')); ?>"
            ...
            <div class="mt-10 grid grid-cols-3 gap-4 border-t border-white/20 pt-8">
                <div>
                    <p class="text-3xl font-extrabold"><?php echo e($facilities->count()); ?></p>
                    <p class="mt-1 text-sm text-blue-100">Fasilitas</p>
                </div>
                <div>
                    <p class="text-3xl font-extrabold"><?php echo e($cooperations->count()); ?></p>
                    <p class="mt-1 text-sm text-blue-100">Kerja Sama</p>
                </div>
                <div>
                    <p class="text-3xl font-extrabold"><?php echo e($rektors->count()); ?></p>
        ...
        <div class="relative">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($heroImage): ?>
                <img src="<?php echo e(asset('storage/' . $heroImage)); ?>"
                     alt="B University"
...
<section class="border-b border-slate-100 bg-white py-10">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mb-6 flex flex-col justify-between gap-2 sm:flex-row sm:items-end">
            ...
            <a href="<?php echo e(route('profile')); ?>" class="text-sm font-semibold text-blue-700 hover:text-blue-900">
                Tentang kampus →
            </a>
        </div>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cooperations->count()): ?>
            <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $cooperations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cooperation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="flex h-24 items-center justify-center rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                        <img src="<?php echo e(asset('storage/' . $cooperation->image)); ?>"
                             alt="Logo kerja sama"
    ...
    <div class="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
        <div class="rounded-3xl bg-white p-8 shadow-sm ring-1 ring-slate-200">
            ...
            <p class="mt-5 leading-8 text-slate-600">
                <?php echo e($aboutme->content ?? 'Profil singkat universitas belum tersedia. Silakan lengkapi data melalui CMS.'); ?>
        ...
        <div class="rounded-3xl bg-white p-8 shadow-sm ring-1 ring-slate-200">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($greeting): ?>
                <div class="mt-6 flex flex-col gap-6 sm:flex-row">
                    <img src="<?php echo e(asset('storage/' . $greeting->image)); ?>"
                    ...
                    <div class="leading-8 text-slate-600 [&_a]:text-blue-700 [&_ol]:list-decimal [&_ol]:pl-5 [&_p]:mb-3 [&_strong]:font-semibold [&_ul]:list-disc [&_ul]:pl-5">
                        <?php echo \Illuminate\Support\Str::limit(strip_tags($greeting->content), 280); ?>
                ...
                <article class="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
                    ...
                    <div class="p-6">
                        ...
                        <p class="mt-3 leading-7 text-slate-600">
                            <?php echo e(\Illuminate\Support\Str::limit(strip_tags($facility->content), 140)); ?>
    ...
    <div class="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
        <div>
            <div class="mb-6 flex items-end justify-between">
                ...
                <a href="<?php echo e(route('announcements')); ?>" class="text-sm font-semibold text-blue-700 hover:text-blue-900">
                    Lihat semua →
                </a>
            </div>

            <div class="space-y-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $latestAnnouncements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <article class="rounded-2xl border border-slate-200 p-5 transition hover:border-blue-200 hover:bg-blue-50/40">
                        <h3 class="font-bold text-slate-900"><?php echo e($announcement->title); ?></h3>
                        <p class="mt-2 text-sm text-slate-600">
                            <?php echo e(\Illuminate\Support\Str::limit(strip_tags($announcement->content), 120)); ?>

                        </p>
                        <p class="mt-3 text-xs text-slate-500">
                            Oleh <?php echo e($announcement->user?->name ?? 'Admin'); ?> • <?php echo e($announcement->created_at?->format('d M Y')); ?>
        ...
        <div>
            <div class="mb-6 flex items-end justify-between">
                ...
                <a href="<?php echo e(route('news')); ?>" class="text-sm font-semibold text-blue-700 hover:text-blue-900">
                    Lihat semua →
                </a>
            </div>

            <div class="space-y-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $latestNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <article class="flex gap-4 rounded-2xl border border-slate-200 p-4 transition hover:border-blue-200 hover:bg-blue-50/40">
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-sm text-slate-600">
                                <?php echo e(\Illuminate\Support\Str::limit(strip_tags($item->content), 90)); ?>

                            </p>
                            <p class="mt-2 text-xs text-slate-500">
                                Oleh <?php echo e($item->user?->name ?? 'Admin'); ?> • <?php echo e($item->created_at?->format('d M Y')); ?>
...
<section class="bg-slate-50 py-20">
    <div class="mx-auto max-w-5xl rounded-3xl bg-gradient-to-br from-blue-700 to-blue-950 px-6 py-14 text-center text-white shadow-xl sm:px-10">
        ...
        <div class="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
            <a href="<?php echo e(route('profile')); ?>" class="rounded-xl bg-white px-6 py-3 text-sm font-bold text-blue-900 hover:bg-blue-50">
                Lihat Profil
            </a>
            <a href="<?php echo e(route('news')); ?>" class="rounded-xl border border-white/30 px-6 py-3 text-sm font-bold text-white hover:bg-white/10">
                Baca Berita
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\rpl-rafael\Nommensen\resources\views/landingpage.blade.php ENDPATH**/ ?>